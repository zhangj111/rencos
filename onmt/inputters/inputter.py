...
def build_dataset(fields, data_type, src_data_iter=None, src_path=None,
    ...
    if ref_path or ref_data_iter:
        ...
        for i, path in enumerate(ref_path):
            ref_examples_iter, num_ref_feats = \
                TextDataset.make_text_examples_nfeats_tpl(
                    ref_data_iter, path, ref_seq_length_trunc, "ref%d"%i)
            ref_examples_iters.append(ref_examples_iter)
    else:
        ref_examples_iters, num_ref_feats = None, None
    ...
    if data_type == 'text':
        dataset = TextDataset(fields, src_examples_iter, tgt_examples_iter,
                              ...
                              ref_examples_iter=ref_examples_iters, num_ref_feats=None, ignore_unk=ignore_unk)
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    if data_type == 'text':
        if ref_vocab_size:
            _build_field_vocab(fields["ref"], counter["src"],
